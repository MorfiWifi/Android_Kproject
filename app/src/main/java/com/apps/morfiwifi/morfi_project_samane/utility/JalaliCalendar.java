...
public class JalaliCalendar extends Calendar {
    ...
    public static class gDate
    {
        ...
        public static String miladi_to_jalali (Date date){
            Calendar ca = Calendar.getInstance();
            ca.setTime(date);

            JalaliCalendar.gDate jcal = new JalaliCalendar.gDate(ca.get(Calendar.YEAR) ,ca.get(Calendar.MONTH) , ca.get(Calendar.DAY_OF_MONTH));
            JalaliCalendar.gDate mi_Ja =  JalaliCalendar.MiladiToJalali(jcal);

            String res = mi_Ja.getYear()+"/"+mi_Ja.getMonth()+"/"+
                    mi_Ja.getDay() +" "+ ca.get(Calendar.HOUR) + ":"
    ...
    public static Date jalali_to_miladi (int Y , int M , int D){
        Calendar ca = Calendar.getInstance();
        JalaliCalendar.gDate jcal = new JalaliCalendar.gDate(Y ,M , D);
        JalaliCalendar.gDate date_miladi =  JalaliCalendar.jalaliToMiladi(jcal);
        ca.set(Calendar.YEAR , date_miladi.year);
        ca.set(Calendar.MONTH , date_miladi.month);
        ca.set(Calendar.DAY_OF_MONTH , date_miladi.day);
        return ca.getTime();
    }

    public static Date jalali_to_miladi (String Y , String M , String D){
        ...
        Calendar ca = Calendar.getInstance();
        JalaliCalendar.gDate jcal = new JalaliCalendar.gDate(YY ,MM , DD);
        JalaliCalendar.gDate date_miladi =  JalaliCalendar.jalaliToMiladi(jcal);
        ca.set(Calendar.YEAR , date_miladi.year);
        ca.set(Calendar.MONTH , date_miladi.month);
        ca.set(Calendar.DAY_OF_MONTH , date_miladi.day);
