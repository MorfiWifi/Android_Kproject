...
public class request_RecyclerAdapter extends RecyclerView.Adapter<ViewHolder_request>  {
    ...
    public request_RecyclerAdapter (List<Request> reportList) {
...
//                        Repository.GetInstant(activity).getReportDao().update(sample_report);
    ...
    public static void Init(List<Request> reportList, AppCompatActivity activity){
        ...
        request_RecyclerAdapter.activity = activity;
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(activity);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.setHasFixedSize(false);
        recyclerView.setAdapter(new request_RecyclerAdapter(reportList));
